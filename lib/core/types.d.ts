...
export declare function resolveUploadConfig(options: EditorOptions): Required<Pick<UploadConfig, "imageUploadURL" | "imageCrawlURL" | "videoUploadURL">> & Pick<UploadConfig, "uploadImage" | "uploadVideo">;
